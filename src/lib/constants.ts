...
export const FEST_DATE = new Date('2026-07-20T09:00:00');
export const FEST_VENUE = 'SFGC Yelahanka Campus, Bengaluru';
export const FEST_TAGLINE = 'Enter the Castle. Prove Your Realm.';
export const COLLEGE_NAME = 'Seshadripuram First grade College';
export const DEPT_NAME = 'Seshadripuram Institute of Management Studies';
